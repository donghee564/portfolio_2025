  ...
  const projects = [
    {
      ...
      modalDescription: [
        ...
        "Chart.js 를 활용하여 바 차트, 라인 차트, 도넛 차트 등 다양한 차트 구현",
        "금액포멧 처리 및 차트 데이터 동적 변경 가능",
      ],
    },
    {
      id: 2,
      ...
      modalDescription: [
        ...
        "적용된 기능 및 모션 : 숫자 슬롯 애니메이션, 스크롤 페이드 인 애니메이션, 스크롤 이동 네비게이션 메뉴, 월 받은 실적 혜택 조회 차트 해당 월만 강조되도록 금액 말풍선 구현, 쿠팡 쇼핑 라이브 타이머 및 방송 시 남은 방송시간 게이지 구현",
      ],
    },
    {
      id: 3,
    ...
    },
    {
      ...
      modalDescription: [
        "퍼블리싱 100%",
        "스탬프 이벤트 : 카운트 및 스탬프 조회 이벤트 페이지 모션 구현",
        "미션 이벤트 : 조건에 따라 미션 버튼이 활성화되고 버튼 클릭 시 길을따라 이동하는 모션 구현",
        "만들기 시리즈 : 버튼 클릭 시 토핑을 넣어 완성하는 모션 구현",
