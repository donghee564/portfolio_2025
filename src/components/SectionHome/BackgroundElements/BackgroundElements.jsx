  ...
  useEffect(() => {
    ...
    const drawWave = () => {
      ...
      for (let i = 0; i < waveCount; i++) {
        ...
        const opacity = isMobile.current ? 0.06 - i * 0.01 : 0.1 - i * 0.02;
        waveGradient.addColorStop(0, `rgba(147, 51, 234, ${opacity})`);
        waveGradient.addColorStop(0.5, `rgba(59, 130, 246, ${opacity})`);
        waveGradient.addColorStop(1, `rgba(236, 72, 153, ${opacity})`);
